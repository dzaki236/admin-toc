...
<head>
  ...
  <title>{{ $title ?? config('app.name') }} - Admin TOC</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav main-color sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item {{ Request::is('admin/category*') ? ' active' :  '' }} {{ Request::is('admin/product*') ? ' active' :  '' }}">
        ...
        <div id="collapseOne" class="collapse {{ Request::is('admin/category*') ? ' show' :  '' }} {{ Request::is('admin/product*') ? ' show' :  '' }}" aria-labelledby="headingOne" data-parent="#accordionSidebar">
      ...
      {{-- <li class="nav-item {{ Request::is('admin/reseller*') ? ' active' :  '' }} {{ Request::is('admin/product*') ? ' active' :  '' }}">
        ...
        <div id="collapseTwo" class="collapse {{ Request::is('admin/reseller*') ? ' show' :  '' }} {{ Request::is('admin/reseller*') ? ' show' :  '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">RESELLER & REVENUE</h6>
            <a class="collapse-item {{ Request::is('admin/reseller-mitra') ? ' active' : '' }}" href="{{ route('admin.reseller.index') }}">DATA MITRA</a>
            <a class="collapse-item {{ Request::is('admin/reseller-profit') ? ' active' : '' }}" href="{{ route('admin.konfig.profit') }}">KONFIG PROFIT</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile main-color rounded-circle" src="{{ auth()->user()->avatar_url }}">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Hak Cipta Dilindungi &copy; 2021 lapasar.com </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
