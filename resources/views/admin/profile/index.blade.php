        ...
        <div class="col-md-5 mb-5">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <br>
                        Dengan Menekan Enable Two Factor Kamu Dapat Mengaktifkan Keamanan 2 Tahap 
                        <div class="alert alert-primary" role="alert">
                            1. Login Web 
                          </div>
                          <div class="alert alert-primary" role="alert">
                            2. dan Authentikasi Handphone (Google Authenticator)
                          </div>
                    ...
                    <p>
                        Otentikasi dua faktor sekarang diaktifkan. Pindai kode QR berikut menggunakan aplikasi pengautentikasi ponsel Anda.(Google Authenticator)
                    </p>
